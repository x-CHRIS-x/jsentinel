...
1. **Download the Extension:**
   - Download the package directly from [`vscode-extension/jsentinel-1.1.0.vsix`](vscode-extension/jsentinel-1.1.0.vsix) or from the [Releases](https://github.com/x-CHRIS-x/jsentinel/releases) tab.
2. **Install into VS Code:**
   - Open Visual Studio Code.
   - Open the Extensions view (`Ctrl+Shift+X` / `Cmd+Shift+X`).
   - Click the `...` menu (Views and More Actions) at the top of the Extensions pane.
   - Select **Install from VSIX...** and select `jsentinel-1.1.0.vsix`.
   - *Alternative (via command line):*
     ```bash
     code --install-extension vscode-extension/jsentinel-1.1.0.vsix
     ```
